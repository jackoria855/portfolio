...
*   **Impact:** Orchestrated specialized agent roles (architect, coder, auditor) to automate complex problem-solving loops.

### Enterprise ERP Data Pipelines
*   **Engineering:** Created Python parsing scripts to extract, transform, and migrate legacy E2 JobBOSS² data structures into **Microsoft Dynamics 365 Business Central**.
*   **Impact:** Safely handled production-critical routing, quote, shipment, and inventory records for the CBB Group of Companies.

### Least Cost Charge (LCC) Optimization Engine
